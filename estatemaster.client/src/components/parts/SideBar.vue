					...
					<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
							...
							<div class="menu-sub menu-sub-accordion">
								...
								<div class="menu-item">
									...
									<a class="menu-link">
										...
										<span class="menu-title">Dosyalar</span>
									</a>
									<!--end:Menu link-->
								</div>
								<!--end:Menu item-->
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<span class="menu-link">
								...
								<span class="menu-title">Kullanıcı Yönetim Paneli</span>
								<span class="menu-arrow"></span>
							</span>
							<!--end:Menu link-->
							<!--begin:Menu sub-->
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
							...
							<div class="menu-sub menu-sub-accordion">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<router-link :to="{ name: 'PropertiesList' }">
										<a class="menu-link">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Mülkler</span>
										</a>
									</router-link>
									<!--end:Menu link-->
								</div>
								...
								<div class="menu-item">
									...
									<router-link :to="{ name: 'PropertiesCreate' }">
										<a class="menu-link">
											...
											<span class="menu-title">Mülk Ekle</span>
										</a>
									</router-link>
									<!--end:Menu link-->
								</div>
